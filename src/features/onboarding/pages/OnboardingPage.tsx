...
function ConsentSheet({ onConfirm, onClose }: { onConfirm: () => void; onClose: () => void }) {
  ...
  return (
    <div className="fixed inset-0 z-40 flex flex-col justify-end">
      ...
      <div
        className={`relative bg-white rounded-t-3xl pt-4 transition-transform duration-300 ease-out ${
